...
**Durée :** 1 semaine — 2 cours

## Objectif du Sprint

Créer une première version fonctionnelle du préprocesseur capable de lire un document Word `.docx`, d’en extraire le texte et de reconnaître sa structure de base.

## Éléments sélectionnés du Product Backlog
